...
package Sf.Graphics.RenderStates is
   ...
   type sfRenderStates is record
      ...
      --/< Blending mode
      stencilMode    : aliased Sf.Graphics.sfStencilMode :=
        Sf.Graphics.sfStencilModeDefault;
      --/< Stencil mode
      transform : aliased Sf.Graphics.Transform.sfTransform := Sf.Graphics.Transform.Identity;
      --/< Transform
      coordinateType : aliased Sf.Graphics.sfCoordinateType :=
        Sf.Graphics.sfCoordinateTypeNormalized;
   ...
   function create
     (blendMode : Sf.Graphics.BlendMode.sfBlendMode := Sf.Graphics.BlendMode.sfBlendAlpha;
      stencilMode    : Sf.Graphics.sfStencilMode := Sf.Graphics.sfStencilModeDefault;
      transform : Sf.Graphics.Transform.sfTransform := Sf.Graphics.Transform.Identity;
      coordinateType : Sf.Graphics.sfCoordinateType := Sf.Graphics.sfCoordinateTypeNormalized;
      texture : sfTexture_Ptr := null;
