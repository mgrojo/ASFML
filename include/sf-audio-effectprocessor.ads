...
package Sf.Audio.EffectProcessor is
   ...
   --/
   --//////////////////////////////////////////////////////////
   type sfEffectProcessor is access procedure
     (inputFrames        : access float;
      inputFrameCount    : access sfUint32;
      outputFrames       : access float;
      outputFrameCount   : access sfUint32;
      frameChannelCount  : sfUint32);

private

   pragma Convention (C, sfEffectProcessor);

end Sf.Audio.EffectProcessor;
