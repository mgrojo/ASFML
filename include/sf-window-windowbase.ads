...
package Sf.Window.WindowBase is
  ...
  --//////////////////////////////////////////////////////////
   ...
   sfWindowed   : constant sfWindowState := Sf.Window.sfWindowed;
   sfFullscreen : constant sfWindowState := Sf.Window.sfFullscreen;
   ...
   function create
     (mode  : Sf.Window.VideoMode.sfVideoMode;
      ...
      state : sfWindowState := sfWindowed) return sfWindowBase_Ptr;
   ...
   function createFromHandle
     (handle : Sf.Window.WindowHandle.sfWindowHandle) return sfWindowBase_Ptr;
   ...
   --//////////////////////////////////////////////////////////
   function pollEvent
     (windowBase : sfWindowBase_Ptr; event : access Sf.Window.Event.sfEvent)
      return sfBool;
   ...
   function getPosition
     (windowBase : in sfWindowBase_Ptr) return Sf.System.Vector2.sfVector2i;
   ...
   procedure setPosition
     (windowBase : sfWindowBase_Ptr; position : Sf.System.Vector2.sfVector2i);
   ...
   --//////////////////////////////////////////////////////////
   function getSize
     (windowBase : in sfWindowBase_Ptr) return Sf.System.Vector2.sfVector2u;
   ...
   --//////////////////////////////////////////////////////////
   procedure setSize
     (windowBase : sfWindowBase_Ptr; size : Sf.System.Vector2.sfVector2u);
   ...
   procedure setUnicodeTitle
     (windowBase : sfWindowBase_Ptr; title : Wide_Wide_String);
   ...
   procedure setMouseCursorVisible
     (windowBase : sfWindowBase_Ptr; visible : sfBool);
   ...
   procedure setMouseCursorGrabbed
     (windowBase : sfWindowBase_Ptr; grabbed : sfBool);
   ...
   procedure setMouseCursor
     (windowBase : sfWindowBase_Ptr; cursor : sfCursor_Ptr);
   ...
   procedure setKeyRepeatEnabled
     (windowBase : sfWindowBase_Ptr; enabled : sfBool);
   ...
   procedure setJoystickThreshold
     (windowBase : sfWindowBase_Ptr; threshold : float);
   ...
   function getNativeHandle
     (windowBase : in sfWindowBase_Ptr)
...
private
   ...
   pragma Import (C, getNativeHandle, "sfWindowBase_getNativeHandle");
